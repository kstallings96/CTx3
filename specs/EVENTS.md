...
| Decomposition | step sequence; reorder-vs-add across revisions | MonsterMaker (per student) |
| Stochastic reasoning | distinct outputs across five identical runs | MonsterMaker (class-level) |
